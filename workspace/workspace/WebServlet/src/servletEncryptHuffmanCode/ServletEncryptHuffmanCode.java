...
public class ServletEncryptHuffmanCode extends HttpServlet{
	...
	throws ServletException, IOException {
		...
		out.println("<!DOCTYPE htmL>\n <html>\n" +
				...
				"</table><table><tr>"+
				"<td>"+
				"Ciphered Text</td></tr><tr>"+
				"<textarea style=\"width:600px;\" name=\"textarea\" rows=\"10\" cols=\"50\">"+EncryptHuffmanCode.encryptString()+"</textarea>"+
				"</td>"+
				
				"<td>"+
				"Original Text</td></tr><tr>"+
				"<textarea style=\"width:600px;\" name=\"textarea\" rows=\"10\" cols=\"50\">"+EncryptHuffmanCode.originalString()+"</textarea>"+
				"</td>"+
				"<tr>"
				+"</table>" 
